...
const init = (suffix = '') => {
    ...
    var videoElement = document.querySelector(`#video${suffix}`);
    var audioSelect = document.querySelector(`select#audioSource${suffix}`);
    var videoSelect = document.querySelector(`select#videoSource${suffix}`);
